...
### VCF练习 ✅
40道VCF题库，分4个难度等级，提升连续冲四技巧。包含入门、初级、中级、高级四个难度，每个难度10道精心设计的题目。
...
- 新增40道VCF练习题库，覆盖4个难度等级
- 新增`VCFPracticeManager`模块，支持题目随机、走法验证、进度追踪
- index.html新增VCF模式UI（模式按钮、难度选择、操作面板、状态卡片）
- demo.js集成VCF依赖，为后续交互逻辑奠定基础
